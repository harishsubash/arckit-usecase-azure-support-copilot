...
|---|---|---|
| Architecture Principles | [`../000-global/ARC-000-PRIN-v1.0.md`](../000-global/ARC-000-PRIN-v1.0.md) | The 8 principles governing every design decision in this project |
| Stakeholder Analysis | [`ARC-001-STKE-v1.0.md`](ARC-001-STKE-v1.0.md) | Who is affected by, or can influence, the copilot programme |
| Requirements | [`ARC-001-REQ-v1.0.md`](ARC-001-REQ-v1.0.md) | Business, functional, and non-functional requirements |
| Risk Register | [`ARC-001-RISK-v1.0.md`](ARC-001-RISK-v1.0.md) | 10 identified risks with likelihood/impact scoring and mitigations |
| Business Case | [`ARC-001-SOBC-v1.0.md`](ARC-001-SOBC-v1.0.md) | Strategic, economic, commercial, financial, and management cases |
| Architecture Strategy | [`ARC-001-STRAT-v1.0.md`](ARC-001-STRAT-v1.0.md) | Target state, phased rollout roadmap, and guardrails |
| Platform Design | [`ARC-001-PLAT-v1.0.md`](ARC-001-PLAT-v1.0.md) | Full Azure architecture and request-sequence diagrams |
| ADR-001 | [`decisions/ARC-001-ADR-001-v1.0.md`](decisions/ARC-001-ADR-001-v1.0.md) | Why Azure AI Search over a self-hosted vector database |
| ADR-002 | [`decisions/ARC-001-ADR-002-v1.0.md`](decisions/ARC-001-ADR-002-v1.0.md) | Why confidence-threshold agent handoff over full AI autonomy |
