...
- **Scope discipline:** this strategy explicitly excludes voice, proactive outbound messaging, and autonomous ticket closure — see ARC-001-REQ-v1.0 "Out of Scope".

## Dependencies on Other Artifacts

- Requirements (`ARC-001-REQ-v1.0`) define the quality gates referenced above.
- Platform Design (`ARC-001-PLAT-v1.0`) implements the architecture this strategy describes.
